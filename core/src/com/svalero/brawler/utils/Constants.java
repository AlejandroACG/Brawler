...
public class Constants {
    ...
    public static final float KAIN_ATTACK_OFFSET_X = (KAIN_WIDTH / 2 + KAIN_ATTACK_WIDTH / 2) * KAIN_SCALE;
    public static final float KAIN_ATTACK_OFFSET_Y = (KAIN_ATTACK_HEIGHT / 2) * KAIN_SCALE;
    ...
    public static final float KAIN_JUMP_ATTACK_OFFSET_X = (KAIN_WIDTH / 2 + KAIN_JUMP_ATTACK_WIDTH / 2) * KAIN_SCALE;
