...
public class Constants {
    ...
    public static final float BISHAMON_SPECIAL_ATTACK_PREP_DURATION = 0.1f;
    ...
    public static final float BISHAMON_SPECIAL_ATTACK_OFFSET_Y = -(BISHAMON_SPECIAL_ATTACK_HEIGHT / 2) -3 * BISHAMON_SCALE;
